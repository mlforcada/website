...
<xsl:template match="/">
  <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ct" lang="ct"><xsl:text>
  </xsl:text>
  <head>
...
<tr><td>
<font face="arial,helvetica">docència</font>
</td></tr>
<tr><td>
...
<xsl:apply-templates select="webpage/teaching"/>
  <xsl:text>
   ...
   <h2><font face="arial,helvetica"><xsl:text>Docència (curs </xsl:text>
   <xsl:value-of select="academicyear"/><xsl:text>)</xsl:text></font></h2>
   <xsl:for-each select="subject">
   <table bgcolor="EEEEEE">
   <tr><td  valign="top"><font face="arial,helvetica"><b>Assignatura:</b></font></td>
   <xsl:choose>
   ...
   <tr><td valign="top"><font face="arial,helvetica"><b>Titulació:</b></font></td>
   <td valign="top"><font face="arial,helvetica"><i><xsl:value-of
   select="degree"/></i></font></td>
   </tr>
   <tr><td></td></tr>
   </table>
   </xsl:for-each>
