...
<tr><td>
<font face="arial,helvetica">publications</font>
</td></tr>
<!--
<tr><td>
...
<xsl:template match="publications">
  <h1><font face="arial,helvetica">Publications (archive)</font></h1>
 ...
 <font face="arial,helvetica"><a href="#{.//year}"><xsl:value-of select=".//year"/></a><xsl:text> </xsl:text></font>
  ...
  href="docum/{./@key}.ps"><b>[PS]</b></a><xsl:text>
      ...
      <xsl:if test="boolean(count(pdfslides-available))">
      <xsl:text> </xsl:text><a
  href="docum/{./@key}.slides.pdf"><b>[PDF slides]</b></a><xsl:text>
  </xsl:text>
      </xsl:if>
  </font></p>
  <xsl:text>
